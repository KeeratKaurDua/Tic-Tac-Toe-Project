...
public class TicTacToeProject {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					TicTacToeProject window = new TicTacToeProject();
	...
	//For Player X//
		if(b1==1 && b2==1 & b3==1)
		{
			...
			xCount1++;
			textField.setText(String.valueOf(xCount1));
		}
		...
		{
			JOptionPane.showConfirmDialog(frame, "Player 0 Wins","Tic Tac Toe",JOptionPane.INFORMATION_MESSAGE);
			oCount1++;
			textField_1.setText(String.valueOf(oCount1));
		}
		...
		{
			JOptionPane.showConfirmDialog(frame, "Nobody Wins","Tic Tac Toe",JOptionPane.INFORMATION_MESSAGE);
	...
	private void initialize() {
		frame = new JFrame();
		frame.setBounds(100, 100, 700, 489);
		...
		panel_2.add(panel_18, BorderLayout.CENTER);
		...
		JLabel xCount = new JLabel("Player X");
		...
		textField.setText("0");
		panel_7.add(textField, BorderLayout.CENTER);
		...
		JLabel oCount = new JLabel("Player 0");
		...
		JButton brnExit = new JButton("EXIT");
		brnExit.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
		...
		brnExit.setFont(new Font("Tahoma", Font.BOLD, 25));
		panel_17.add(brnExit, BorderLayout.CENTER);
	}
